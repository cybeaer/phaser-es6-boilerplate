...
function copySpine() {
    ...
    var srcList = ['phaser-spine.min.js'];

    if (!isProduction()) {
        srcList.push('phaser-spine.js','phaser-spine.js.map');
    }

    srcList = srcList.map(function(file) {
        return SPINE_PATH + file;
    });
...
gulp.task('watch-static', ['copySpine'], browserSync.reload);
